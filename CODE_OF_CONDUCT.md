...
This Code of Conduct applies within all community spaces — the repository, its issues and pull
requests, and the project's Discord — and also applies when an individual is officially representing
...
[private report on the repository](https://github.com/ronak-create/Lynx/security/advisories/new) or a
direct message to a maintainer on [Discord](https://discord.gg/XdMmjD5qU). All complaints will be
...
1. **Correction** — a private, written warning, with clarity about the nature of the violation and an
